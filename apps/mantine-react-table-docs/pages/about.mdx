...
Mantine React Table is licensed under the [MIT License](https://github.com/KevinVandy/mantine-react-table/blob/v1/LICENSE) and is free to use in both personal and commercial projects.
...
If you would like to contribute code to the project, please read the [Contributing Guide](https://github.com/kevinvandy/mantine-react-table/blob/v1/CONTRIBUTING.md) to learn how to get started.
