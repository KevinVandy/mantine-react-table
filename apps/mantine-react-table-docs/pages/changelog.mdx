...
- Added zh-Hans and zh-Hant translations that can be imported from `'mantine-react-table/locales/zh-Hans'` and `'mantine-react-table/locales/zh-Hant'` respectively
...
- Fix select placeholder when mantineEditTextInputProps.placeholder is set

#### v1.4.2 (2022-12-11)

- Fix custom `mantineTableBodyProps.children` not being rendered
...
- Added nl translations that can be imported from `'mantine-react-table/locales/nl'`
- Updated ru translations that can be imported from `'mantine-react-table/locales/ru'`
...
- Added ro translations that can be imported from `'mantine-react-table/locales/ro'`
...
- Added vi translations that can be imported from `'mantine-react-table/locales/vi'`
- Upgraded to latest TanStack Table 8.6.0 for new `maxLeafRowFilterDepth` prop

#### v1.3.10 (2022-11-19)

- Added fr translations that can be imported from `'mantine-react-table/locales/fr'`
...
- Added tr translations that can be imported from `'mantine-react-table/locales/tr'`
...
- Added fa translations that can be imported from `'mantine-react-table/locales/fa'`
...
- Added it translations that can be imported from `'mantine-react-table/locales/it'`
...
- Added ru translations that can be imported from `'mantine-react-table/locales/ru'`

#### v1.0.9 (2022-09-17)

- Added de translations that can be imported from `'mantine-react-table/locales/de'`
...
- Added cs translations that can be imported from `'mantine-react-table/locales/cs'`

#### v1.0.3 (2022-09-14)

- Fixed sticky header z-index issue with select checkboxes and expand buttons
- Added pl translations that can be imported from `'mantine-react-table/locales/pl'`

#### v1.0.2 (2022-09-13)

- Added es translations that can be imported from `'mantine-react-table/locales/es'`
...
- v1.0.0-beta.6 - `onColumnDrop` and `onRowDrop` props removed, since they can easily be hooked up manually in `mantineTableBodyRowCellDragHandleProps`
...
- v0.38.0 - New `GroupedColumn` cell render column def option, new `mantineToolbarAlertBannerChipProps`, renamed `mantineTableToolbarAlertBannerProps` to `mantineToolbarAlertBannerProps`, `mantineTableTopToolbarProps` to `mantineTopToolbarProps`, `mantineTableBottomToolbarProps` to `mantineBottomToolbarProps`
...
- v0.36.0 - `onCellEditBlur` and `onCellEditChange` props removed because the already exist on `mantineEditTextInputProps`. Examples given [here](/docs/guides/editing)
