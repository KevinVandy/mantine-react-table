...
<Head>
  <title>{'Cell Instance APIs - Mantine React Table V2 Docs'}</title>
  <meta
    name="description"
...
> NOTE: These are NOT [props](/docs/api/props) or [column options](/docs/api/column-options) for Mantine React Table. These are just static methods on a cell instance that you can use.
