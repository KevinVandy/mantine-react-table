...
<Head>
  <title>{'Popover Filters Example - Mantine React Table V2 Docs'}</title>
  <meta
    name="description"
    content="An example of Mantine React Table which shows an excel-like column filters."
  />
  <meta
    property="og:title"
    content="Popover Filters Mantine React Table Example"
  />
  <meta
