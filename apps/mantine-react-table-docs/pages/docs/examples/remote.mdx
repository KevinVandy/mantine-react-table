...
<Head>
  <title>Remote Data Example - Mantine React Table Docs</title>
  <meta
    name="description"
...
Also, be sure to check out the [TanStack React Query Example](/docs/examples/react-query), which is very similar to this one, except it uses react-query to simplify much of the state management needed for fetching data.
