...
<Head>
  <title>{'Faceted Values Example - Mantine React Table V2 Docs'}</title>
  <meta
    name="description"
    content="An example of Mantine React Table which shows how to use faceted values to automatically populate filter suggestions."
  />
  <meta
    property="og:title"
    content="Faceted Values Mantine React Table Example"
  />
  <meta
