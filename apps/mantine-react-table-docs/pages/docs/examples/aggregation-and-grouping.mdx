...
<Head>
  <title>Aggregation and Grouping Example - Mantine React Table Docs</title>
  <meta
    name="description"
    content="A Mantine React Table example demonstrating aggregation and grouping. See how you can group rows by a column and aggregate the values of other columns."
  />
  <meta
    property="og:title"
