...
> If your language is not yet supported, please consider making a PR to add it to the library! See [here on GitHub](https://github.com/KevinVandy/mantine-react-table/tree/v1/packages/mantine-react-table/src/locales).
...
For a full list of all available translation keys, see [here](https://github.com/KevinVandy/mantine-react-table/blob/v1/packages/mantine-react-table/src/locales/en.ts)
