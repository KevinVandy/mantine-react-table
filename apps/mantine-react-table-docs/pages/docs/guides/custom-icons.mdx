...
To replace a default icon, specify the icon in the `icons` prop. You should get TS hints for the name of the icons you can replace, but you can also consult [this source file](https://github.com/KevinVandy/mantine-react-table/blob/v1/packages/mantine-react-table/src/icons.ts) for a list of all the icons you can replace.
