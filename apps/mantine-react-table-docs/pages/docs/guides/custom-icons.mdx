...
Mantine React Table uses [Material Icons](https://mui.com/material-ui/material-icons) by default for all of its internal icons.
...
<MantineReactTable
  ...
  icons={{
    ...
    IconArrowsSort: (props) => (<FontAwesomeIcon icon={faArrowDownWideShort} {...props} />), //best practice
  }}
```
