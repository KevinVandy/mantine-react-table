...
import ColumnActionsSpaceExample from '../../../examples/column-actions-menu-space';
...
```tsx
<MantineReactTable data={data} columns={columns} enableColumnActions={false} />
```
...
If you do not like the default column actions menu items that Mantine React Table generates, you can provide your own custom menu items with the `renderColumnActionsMenuItems` prop. x of the column in the table.
