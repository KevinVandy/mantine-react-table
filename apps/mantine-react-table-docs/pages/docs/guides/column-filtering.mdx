...
<StateOptionsTable
  onlyOptions={new Set(['columnFilters', 'columnFilterFns', 'showColumnFilters'])}
/>
...
You can customize the Mantine filter components by setting the `mantineFilterTextInputProps` prop or column option.
