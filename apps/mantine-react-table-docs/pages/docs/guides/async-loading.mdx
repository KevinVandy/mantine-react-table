...
<RootPropTable
  onlyProps={
    new Set(['mantineSkeletonProps', 'mantineLinearProgressProps'])
  }
/>
...
You can customize the linear progress bars by passing props to the `mantineLinearProgressProps` prop.
