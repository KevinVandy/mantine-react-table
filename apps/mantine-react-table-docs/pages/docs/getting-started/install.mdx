...
```bash
npm install mantine-react-table @mantine/core @mantine/hooks @emotion/react @tabler/icons
```

PNPM

```bash
pnpm add mantine-react-table @mantine/core @mantine/hooks @emotion/react @tabler/icons
```

Yarn

```bash
yarn add mantine-react-table @mantine/core @mantine/hooks @emotion/react @tabler/icons
```
