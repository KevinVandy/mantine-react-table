...
> `mantine-react-table` requires **Mantine UI V5** packages as dependencies in your project.
>
> If you are already using Mantine UI, you probably already have most of these peer dependencies installed.
>
