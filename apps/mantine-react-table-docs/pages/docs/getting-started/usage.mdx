...
To start using MantineReactTable, you first need to [install](/docs/getting-started/install) `mantine-react-table` and the necessary Material UI v5 dependencies.
