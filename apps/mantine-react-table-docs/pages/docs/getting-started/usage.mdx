...
> NOTE: The Docs will be going through a refactor soon to encourage use of the `useMantineReactTable` hook. See the [Basic Example](/docs/examples/basic) for an idea of what is coming.
