...
const Example = () => {
  ...
  const fetchMoreOnBottomReached = useCallback(
    (containerRefElement?: HTMLDivElement | null) => {
      const selector = containerRefElement?.querySelector(
        '.mantine-ScrollArea-viewport',
      );
      if (selector) {
        const { scrollHeight, scrollTop, clientHeight } = selector;
  ...
  const table = useMantineReactTable({
    ...
    mantineScrollAreaProps: {
      onScrollPositionChange: () => fetchMoreOnBottomReached(tableContainerRef.current),
    },
