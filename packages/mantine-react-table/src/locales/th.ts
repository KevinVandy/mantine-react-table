...
export const MRT_Localization_TH: MRT_Localization = {
  ...
  dropToGroupBy: 'ลากมาเพื่อจัดกลุ่มตาม {column}',
  edit: 'แก้ไข',
  expand: 'ขยาย',
  ...
  filterIncludesStringSensitive: 'กรองเมื่อมีข้อความว่า (ตรงตามตัวพิมพ์)',
